...
public final class FragmentMainBinding implements ViewBinding {
  ...
  @NonNull
  public final Button noticeButton;
  ...
  private FragmentMainBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView addtodoButton,
      @NonNull Button noticeButton, @NonNull RecyclerView recyclerView,
  ...
  public static FragmentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      Button noticeButton = ViewBindings.findChildViewById(rootView, id);
