...
public final class FragmentCalendarBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageButton addtodoButton;
  ...
  private FragmentCalendarBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageButton addtodoButton, @NonNull CalendarView calendarView,
      @NonNull RecyclerView recyclerView, @NonNull TextView txtTodaylist) {
  ...
  public static FragmentCalendarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ImageButton addtodoButton = ViewBindings.findChildViewById(rootView, id);
